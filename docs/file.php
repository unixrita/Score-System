...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
     ...
     ?>
      ...
      <ul class="app-menu">
          <li><a class="app-menu__item" href="member_s_t.php"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label"><font>組員管理</font></span></a></li>
             ...
             <li><a class="app-menu__item active" href="file.php"><i class="app-menu__icon fa fa-file-pdf-o"></i><span class="app-menu__label"><font>檔案查看</font></span></a></li>
    ...
    <main class="app-content">
     <div class="app-title">
        <div>
          <h1><p style="font-family: 微軟正黑體; font-weight:600; font-size:30px; font-style:normal">檔案查看</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="index_teacher.php" style="color:black"><i class="fa fa-home fa-lg"></i></a></li>
            <li class="breadcrumb-item"><a href="#" style="color:black"><font>檔案查看</font></a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                <form method="post" action="score.php?team_id=<?php echo $team_id; ?>">
                   <?php
                    ...
                    ?>
                      ...
                      <div class="form-group">
                        <font>專題檔案&nbsp;&nbsp;</font>
                        <a href="<?php echo $row2[team_file]?>" download="<?php echo $row2[team_id]?>.pdf" class="btn btn-info btn-sm"><i class="fa fa-file-pdf-o"></i><font>&nbsp;檔案下載</font></a>
                      </div>
                    <?php
                         }
                     ?>
