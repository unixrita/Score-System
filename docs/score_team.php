        ...
        <div class="col-md-12">
          <div class="tile">
                ...
                <form method="post" action="score.php?team_id=<?php echo $team_id; ?>">
                   <?php
                    ...
                    ?>
                      ...
                      <div class="form-group">
                        <font>評分</font>
                        <input class="form-control" type="text" name="score" autofocus required>
                      </div>
                      <div class="form-group">
                        <font>評語</font>
                    ...
                    <?php
                     ...
                     ?>
                      <div>
                        <p>
                        <input class="btn btn-primary" type="submit" value="完成" name="submitButton">&nbsp;&nbsp;
            ...
            <p style="text-align: right">
              <a href="score.php"><button class="btn btn-primary">回上一頁</button></a>
            </p>
          </div>
        </div>
      </div>
